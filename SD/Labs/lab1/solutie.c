...
*	Laborator 1 - Structuri de date (Probleme pregatitoare - Rezolvari)
*	Grupa 314CC
...
int inmultire(int x, int y) {
	if (y == 0)
		return 0;
	if (y % 2 == 0)
		return inmultire(x+x, y/2);
	return inmultire(x+x, y/2) + x;
}
